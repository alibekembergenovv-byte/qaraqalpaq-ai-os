...
export default async function DashboardPage() {
  // ⚡ Bolt: Use Promise.all to fetch database counts concurrently
  // Impact: Reduces SSR database round-trips from 4 sequential queries to 1 parallel execution batch
  const [
    newsCount,
    contentCount,
    publishedCount,
